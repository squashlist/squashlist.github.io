 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dg="FirebaseError";class Hi extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=dg,Object.setPrototypeOf(this,Hi.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,mf.prototype.create)}}class mf{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},r=`${this.service}/${e}`,s=this.errors[e],o=s?pg(s,i):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new Hi(r,a,i)}}function pg(t,e){return t.replace(mg,(n,i)=>{const r=e[i];return r!=null?String(r):`<${i}?>`})}const mg=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E_="firebase-heartbeat-database",x_=1,Ei="firebase-heartbeat-store";let $s=null;function bf(){return $s||($s=Fg(E_,x_,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(Ei)}catch(n){console.warn(n)}}}}).catch(t=>{throw Rt.create("idb-open",{originalErrorMessage:t.message})})),$s}async function I_(t){try{const n=(await bf()).transaction(Ei),i=await n.objectStore(Ei).get(wf(t));return await n.done,i}catch(e){if(e instanceof Hi)_t.warn(e.message);else{const n=Rt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});_t.warn(n.message)}}}async function ic(t,e){try{const i=(await bf()).transaction(Ei,"readwrite");await i.objectStore(Ei).put(e,wf(t)),await i.done}catch(n){if(n instanceof Hi)_t.warn(n.message);else{const i=Rt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});_t.warn(i.message)}}}function wf(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Br{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=Je.ACK_USER_WRITE,this.source=rh()}operationForChild(e){if(W(this.path)){if(this.affectedTree.value!=null)return E(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new X(e));return new Br(q(),n,this.revert)}}else return E(V(this.path)===e,"operationForChild called for unrelated child."),new Br(te(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
